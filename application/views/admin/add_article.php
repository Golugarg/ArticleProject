 ...
 <fieldset>
    	 ...
    	 <div class="form-group"> 
    	  ...
    	  <div class="col-lg-8">
    	   <!-- <input type="text" class="form-control" id="inputEmail" placeholder="Username"> -->
    	     <?= form_input(['name'=>'title','class'=>'form-control','placeholder'=>'Article Title','value'=>set_value('title')]) ?>
    	  </div>
   		 </div>
    	</div>
    	<div class="col-lg-6">
    ...
    <div class="form-group">
      ...
      <div class="col-lg-8">
      <?= form_textarea(['name'=>'body','class'=>'form-control','placeholder'=>'Article Body','value'=>set_value('Body')]) ?>
      </div>
      </div>
    </div>
    <div class="col-lg-6">
